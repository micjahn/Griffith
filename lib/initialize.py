...
"America)")) 
	...
	self.e_media.insert_text(0, _("DVD")) 
	self.e_media.insert_text(1, _("DVD-R")) 
	self.e_media.insert_text(2, _("DVD-RW")) 
	self.e_media.insert_text(3, _("DVD+R")) 
	self.e_media.insert_text(4, _("DVD+RW")) 
	self.e_media.insert_text(5, _("DVD-RAM")) 
	self.e_media.insert_text(6, _("VHS")) 
	self.e_media.insert_text(7, _("BETACAM")) 
	self.e_media.insert_text(8, _("WMV")) 
	self.e_media.insert_text(9, _("DIVX")) 
	...
	self.am_media.insert_text(2, _("DVD-RW")) 
	self.am_media.insert_text(3, _("DVD+R")) 
	self.am_media.insert_text(4, _("DVD+RW")) 
	self.am_media.insert_text(5, _("DVD-RAM")) 
	self.am_media.insert_text(6, _("VHS")) 
	self.am_media.insert_text(7, _("BETACAM")) 
	self.am_media.insert_text(8, _("WMV")) 
	self.am_media.insert_text(9, _("DIVX")) 
	self.am_media.insert_text(10, _("XVID")) 
	self.am_media.insert_text(11, _("VCD")) 
	self.am_media.insert_text(12, _("SVCD")) 
