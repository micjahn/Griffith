...
char *s = N_("Add language");
char *s = N_("Add movie");
char *s = N_("Add movie and close");
char *s = N_("Add new language entry");
char *s = N_("Add new movie");
char *s = N_("Add person");
...
char *s = N_("Open image in poster window");
...
char *s = N_("Region");
char *s = N_("Remove");
char *s = N_("Remove language");
char *s = N_("Remove last language entry");
...
char *s = N_("Show movies in selected collection");
char *s = N_("Show movies in selected volume");
char *s = N_("Simple");
char *s = N_("Size");
...
char *s = N_("Username");
char *s = N_("Visit the Internet Movie Database (IMDB) related page");
...
char *s = N_("add entered name to languages list");
...
char *s = N_("remove selected language");
char *s = N_("remove selected volume");
char *s = N_("rename collection assigned to movie");
char *s = N_("rename selected language");
char *s = N_("rename volume assigned to movie");
